...
<body class="main-layout">
    ...
    <section>
        <div class="container py-5">
            <div class="row" style="margin-top: 15%; margin-bottom: 5%;">
                <div class="col-lg-4">
                    <div class="card mb-4">
                        <div class="card-body text-center">
                            <img src="./images/glass4.png" alt="avatar" class="rounded-circle img-fluid"
                                style="width: 150px;">
                            ...
                            <div class="d-flex justify-content-center mb-2">
                                <button type="button" data-mdb-button-init data-mdb-ripple-init
                                    class="btn btn-outline-success ms-1">Editar</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0">25 años</p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0">Emprendedor</p>
                                </div>
                            </div>
                        </div>
                    </div>
